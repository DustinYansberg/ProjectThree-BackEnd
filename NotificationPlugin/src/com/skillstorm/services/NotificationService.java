...
public class NotificationService {
	...
	public Notification createNotification(String identityId, String applicationId) throws GeneralException {
		...
		try {
			connection = pluginContext.getConnection();
			statement = PluginBaseHelper.prepareStatement(connection, "INSERT INTO plugin_notification (identityId, applicationId, message, checked, createdAt) "
																	+ "VALUES (?, ?, ?, false, ?)", identityId, applicationId, message, createdAt);
	...
	public Notification getNotification(String identityId, String applicationId) throws GeneralException {
		...
		try {
			connection = pluginContext.getConnection();
			statement = PluginBaseHelper.prepareStatement(connection, "SELECT * FROM plugin_notification WHERE identityId = ? AND applicationId = ?", identityId, applicationId);
	...
	public List<Notification> getNotificationsByIdentityId(String identityId) throws GeneralException {
		...
		try {
			connection = pluginContext.getConnection();
			statement = PluginBaseHelper.prepareStatement(connection, "SELECT * FROM plugin_notification WHERE identityId = ?", identityId);
	...
	public Map<String, String> getNamesByIds(String identityId, String applicationId) throws GeneralException {
			...
			try {
				...
				statement = PluginBaseHelper.prepareStatement(connection, "SELECT * FROM spt_identity WHERE id = ?", identityId);
				...
				statement = PluginBaseHelper.prepareStatement(connection, "SELECT * FROM spt_identity WHERE id = ?", identityMap.get("managerId"));
				...
				statement = PluginBaseHelper.prepareStatement(connection, "SELECT * FROM spt_application WHERE id = ?", applicationId);
				...
				nameMap.put("managerName", managerMap.get("managerName"));
				nameMap.put("applicationName", applicationMap.get("applicationName"));
